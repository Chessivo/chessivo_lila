...
"""
  ...
  def lzTag = jsAt("vendor/lz-string.min.js")
  ...
  def basicCsp(implicit req: RequestHeader): ContentSecurityPolicy =
    ...
    ContentSecurityPolicy(
      ...
      connectSrc =
        "'self'" :: "data:" :: assetDomain.value :: "http://chessivo.com" :: "https://chessivo.com" :: "chessivo.com" :: "localhost" :: "en.wikibooks.org" :: sockets ::: env.explorerEndpoint :: env.tablebaseEndpoint :: localDev,
